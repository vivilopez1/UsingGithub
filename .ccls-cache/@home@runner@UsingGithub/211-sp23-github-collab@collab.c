...
void vlope22_rmirz2(){
  printf("Viviana Lopez and Ruba Mirza\n");
  printf("We learned that the git diff function displays all the changes between the different commits. Another thing is to include HEAD after git diff in order to compare changes with the most recent commit.");
  printf("We also learned that when you run git push, it will send all of your local commits to the remote repository on Github. This makes changes visible to other collaborators.");
}
